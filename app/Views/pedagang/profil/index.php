...
<div class="max-w-2xl space-y-6">
    <div class="card">
        ...
        <?= form_open('pedagang/profil/update') ?>
            <div class="space-y-4">
                <div>
                ...
                <div>
                    <label class="label-field">Alamat Domisili</label>
                    <textarea name="alamat" required rows="2" class="input-field"><?= esc($user['alamat']) ?></textarea>
                </div>
                <div>
                    <label class="label-field">Alamat Toko</label>
                    <textarea name="alamat_toko" required rows="2" class="input-field"><?= esc($user['alamat_toko']) ?></textarea>
                </div>
                <div>
    ...
    <div class="card">
        ...
        <?= form_open('pedagang/profil/password') ?>
            <div class="space-y-4">
