...
class RekeningController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('petani/rekening/index', [
            'pageTitle'    => 'Kelola Rekening',
            'pageSubtitle' => 'Kelola rekening bank/e-wallet Anda untuk menerima pembayaran',
            'rekening'     => $rekening,
            'microNominal' => $microNominal,
            'backUrl'      => '/petani/rekening',
        ]);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/petani/rekening')->with('success', 'Rekening berhasil ditambahkan, silakan lakukan verifikasi.');
    }
    ...
    public function verifikasi(int $id)
    {
        ...
        return redirect()->to('/petani/rekening')->with('success', 'Rekening berhasil diverifikasi dan siap digunakan.');
    }
    ...
    public function hapus(int $id)
    {
        ...
        if (! $ok) {
            return redirect()->to('/petani/rekening')->with('error', 'Rekening tidak ditemukan.');
        }

        return redirect()->to('/petani/rekening')->with('success', 'Rekening berhasil dihapus.');
    }
}