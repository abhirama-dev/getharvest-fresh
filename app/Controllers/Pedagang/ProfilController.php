...
class ProfilController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('pedagang/profil/index', [
    ...
    public function update()
    {
        ...
        return redirect()->to('/pedagang/profil')->with('success', 'Profil berhasil diperbarui.');
    }
    ...
    public function updatePassword()
    {
        ...
        return redirect()->to('/pedagang/profil')->with('success', 'Password berhasil diubah.');
    }
}